      ...
      async (position) => {
        ...
        try {
          ...
          if (res.ok) {
            ...
            setSuggestions([]);
            setSatelliteFlightData({ lat: latitude, lng: longitude, city: cityVal, country: countryVal });
          }
        } catch (e) {
                ...
                <div className="relative">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-3 border border-[#EBE5DE] bg-[#F9F8F6] font-sans text-sm font-medium text-[#1A1A1A] focus:outline-none focus:border-[#1A1A1A] transition-colors rounded-xl"
                    />
                    <button
                      type="button"
                      onClick={handleAutoLocate}
                      className="px-4 py-3 bg-[#1A1A1A] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-[#1A1A1A] rounded-xl font-mono text-[10px] uppercase font-bold tracking-wider transition-all border border-[#D4AF37]/20 flex items-center gap-1.5 shrink-0"
                    >
